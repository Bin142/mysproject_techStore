package com.binhle.storetech.controller;

import com.binhle.storetech.models.Product;
import com.binhle.storetech.models.ProductsDto;
import com.binhle.storetech.services.ProductsRepository;
...
public class ProductsController {
    ...
    public String updateProduct(Model model,
                                @RequestParam int id,
                                @Valid @ModelAttribute ProductsDto productsDto,
                                BindingResult result){
